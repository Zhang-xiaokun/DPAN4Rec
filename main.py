...
@author: zhangxiaokun
Reference: https://github.com/Wang-Shuo/Neural-Attentive-Session-Based-Recommendation-PyTorch/blob/master/main.py
"""
...
from DPAN import DPAN
from dataset import load_data, RecSysDataset

parser = argparse.ArgumentParser()
parser.add_argument('--dataset_path', default='yoochoose1_64/', help='dataset directory path: datasets/diginetica/yoochoose_part_1_64/yoochoose1_4/yoochoose1_64')
parser.add_argument('--batch_size', type=int, default=512, help='input batch size')
parser.add_argument('--hidden_size', type=int, default=50, help='hidden state size of gru module')
...
parser.add_argument('--alpha_pool', type=float, default=0.1, help='degree of SA (alpha) pooling')
parser.add_argument('--beta_pool', type=float, default=0.1, help='degree of CA (beta) pooling')
