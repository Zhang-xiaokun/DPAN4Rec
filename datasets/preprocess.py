...
# add a header for yoochoose datasets
with open('datasets/yoochoose-clicks.dat', 'r') as f, open('datasets/yoochoose-part-clicks-withHeader.dat', 'w') as fn:
    fn.write('sessionId,timestamp,itemId,category'+'\n')
    for line in f:
        fn.write(line)

if args.dataset == 'diginetica':
    dataset = 'datasets/train-item-views.csv'
elif args.dataset =='yoochoose':
    dataset = 'datasets/yoochoose-part-clicks-withHeader.dat'
...
# data augment [x1, x2, x3] -> [x1,V(x20)], [x1, x2, V(x3)],
